### Implement of "Pay Attention to MLPs" for MLP in Transformer.
### From https://github.com/xmu-xiaoma666/External-Attention-pytorch/blob/master/model/mlp/g_mlp.py
