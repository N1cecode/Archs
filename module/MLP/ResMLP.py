### Implement of "ResMLP: Feedforward networks for image classification with data-efficient training" for MLP in Transformer.
### From https://github.com/xmu-xiaoma666/External-Attention-pytorch/blob/master/model/mlp/resmlp.py
