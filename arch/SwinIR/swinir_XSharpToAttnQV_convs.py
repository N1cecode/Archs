...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, x_sharp, mask=None):
        ...
        """
        b_, n, c = x.shape
        k = self.k(x).reshape(b_, n, 1, self.num_heads, c // self.num_heads).permute(2, 0, 3, 1, 4)
        qv = self.qv(x_sharp).reshape(b_, n, 2, self.num_heads, c // self.num_heads).permute(2, 0, 3, 1, 4)
