### Implement of "Sparse MLP for Image Recognition: Is Self-Attention Really Necessary?" for MLP in Transformer.
### From https://github.com/xmu-xiaoma666/External-Attention-pytorch/blob/master/model/mlp/sMLP_block.py
