### Implement of "Vision Permutator: A Permutable MLP-Like Architecture for Visual Recognition" for MLP in Transformer.
### From https://github.com/xmu-xiaoma666/External-Attention-pytorch/blob/master/model/mlp/vip-mlp.py
